...
if __name__ == "__main__":
    print ("### Experiment using Coral architecture")
    tResults = pd.read_csv("../results/optuna.results.Coral.csv")
    ...
    early_stop_callback = load("../results/Coral.earlystopping.dump")
